...
namespace Ankh_Morpork_MVC.Constants
{
    public static class GuildDatas
    {
        ...
        public const string Thieve = "You can get robbed anytime and will have to pay a standard fee to the guild member. But total number of thefts during the game cannot be greater then socially acceptable number of thefts.";
        public const string Beer = "You can pass by The Mended Drum pub and get a beer there. When you will face a beggar who needs a beer they can share it with them.";
        public const string Hood = "You can occasionally found a place to aquire a hood. When you will meet assassin next time you can wear it and avoid the assassin.";
    }
}